      ...
      <div v-else-if="step==='form'" class="post-card">
        ...
        <div class="form-group" style="margin-top:14px">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px">
            <label class="label" style="margin-bottom:0">Job Description *</label>
            <button type="button" class="btn btn-ghost btn-sm" @click="aiWriteDesc" :disabled="aiWriting">
...
async function aiWriteDesc() {
  ...
  try {
    ...
    if (data.text) {
      ...
      toast.success('AI wrote your job description!')
    } else {
